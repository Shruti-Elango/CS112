...
def same_size( image ) :
    # ow, oh = image.size  #get the size of the image - it is a propert so no need for ()
    # nw, nh = ow, 15 #new width is the same as the old width, the new height is set to 15 here
    # return (nw, nh) # return the new width and height in ()
    return image.size
