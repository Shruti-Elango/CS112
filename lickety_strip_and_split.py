...
#print( 'list1: ', list1 )
#print( 'list2: ', list2 )
reply = input ('Enter some word: ')
words = reply.split()
#cannot put different number of variables on the left side because we don't know how many words the use is going to type
# words = list of words from the single string reply
print ( 'words =', words)

# is enter UFOS are oval, then we split---> words = ['UFOs', 'are', 'oval']